<h2><a href="https://www.geeksforgeeks.org/problems/maximum-gap3845/1?page=1&difficulty=Easy&sortBy=difficulty">Maximum Gap</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> of positive elements. Your have to find the <strong>maximum difference</strong> between its two consecutive elements in its sorted form.<br>Return <strong>0 </strong>if the array contains less than 2 elements.</span></p>
